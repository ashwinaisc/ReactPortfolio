      ...
      <div className="about__container container grid">
        ...
        <div className="about__data">
          ...
          <p className="about__description">
            {" "}
            UI/UX Designer Front-End React Developer Creative and
            detail-oriented UI/UX Designer and Front-End Developer with 4 years
            of experience designing user-centric web applications and
