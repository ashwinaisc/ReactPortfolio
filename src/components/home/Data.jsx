...
const Data = () => {
  return (
   <div className="home__data">
    <h1 className="home__title"> ASHWIN ISSAC SHAJI
         <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
 ...
 translating client requirements into visually appealing and functional designs, improving user engagment, and driving business growth.
    </p>
